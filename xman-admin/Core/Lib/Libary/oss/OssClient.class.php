...
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.  "Core/MimeTypes.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.  "Core/OssException.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Http/RequestCore.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Http/RequestCore_Exception.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Http/ResponseCore.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/CorsConfig.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/CnameConfig.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/LoggingConfig.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/LiveChannelConfig.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/LiveChannelInfo.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/LiveChannelListInfo.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/AclResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/BodyResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetCorsResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetLifecycleResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetLoggingResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetRefererResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetWebsiteResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetCnameResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/HeaderResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/InitiateMultipartUploadResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/ListBucketsResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/ListMultipartUploadResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/ListMultipartUploadInfo.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/ListObjectsResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/ListPartsResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/PutSetDeleteResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/DeleteObjectsResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/CopyObjectResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/CallbackResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/ExistResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/PutLiveChannelResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetLiveChannelHistoryResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetLiveChannelInfoResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/GetLiveChannelStatusResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/ListLiveChannelResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/AppendResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/ObjectListInfo.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Result/UploadPartResult.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/BucketListInfo.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/LifecycleConfig.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/RefererConfig.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/WebsiteConfig.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Core/OssUtil.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR. "Model/ListPartsInfo.php";
...
class OssClient
{
   ...
   public function getLiveChannelHistory($bucket, $channelName, $options = NULL)
     ...
     * @return array
     * @throws OssException
     * @link http://help.aliyun.com/document_detail/api-reference/cors/OptionObject.html
     */
